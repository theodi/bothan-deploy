# Contributing to Bothan-Deploy

Bothan-Deploy is open source, and contributions are gratefully accepted!
...
Ensure that the [tests](https://github.com/theodi/bothan-deploy/blob/master/README.md#tests) pass before working on your contribution
